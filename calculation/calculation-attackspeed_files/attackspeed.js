function init1() {
    ...
    document.f.r1.value = 10;
    document.f.r2.value = 0;
    document.f.r3.value = 20;
    document.f.r4.value = 10;
    document.f.r5.value = 1;
    document.f.r6.value = 1.2;
    document.f.r7.value = 0.8333333333333334;
    document.f.r8.value = 23;
    document.f.r9.value = 0;
    document.f.r10.value = 20;
    document.f.r11.value = 17;
    document.f.r12.value = 2;
    document.f.r13.value = 0.5217391304347826;
    document.f.r14.value = 1.9166666666666667;

    document.f.a2.options[0] = new Option('0.75',0.75, 1, 1);
    document.f.a2.options[1] = new Option('0.80',0.80);
    document.f.a2.options[2] = new Option('0.90',0.90);
    document.f.a2.options[3] = new Option('1.00',1.00);
    document.f.a2.options[4] = new Option('1.10',1.10);
    document.f.a2.options[5] = new Option('1.20',1.20);
    document.f.a2.options[6] = new Option('1.30',1.30);
    document.f.a2.options[7] = new Option('1.40',1.40);
    document.f.a2.options[8] = new Option('1.50',1.50);
    document.f.a2.options[9] = new Option('1.60',1.60);
    document.f.a2.options[10] = new Option('1.70',1.70);
    document.f.a2.options[11] = new Option('1.80',1.80);

    document.f.a4.options[0] = new Option('0.75',0.75);
    document.f.a4.options[1] = new Option('0.80',0.80);
    document.f.a4.options[2] = new Option('0.90',0.90);
    document.f.a4.options[3] = new Option('1.00',1.00);
    document.f.a4.options[4] = new Option('1.10',1.10);
    document.f.a4.options[5] = new Option('1.20',1.20);
    document.f.a4.options[6] = new Option('1.30',1.30);
    document.f.a4.options[7] = new Option('1.40',1.40);
    document.f.a4.options[8] = new Option('1.50',1.50);
    document.f.a4.options[9] = new Option('1.60',1.60);
    document.f.a4.options[10] = new Option('1.70',1.70);
    document.f.a4.options[11] = new Option('1.80',1.80, 1, 1);
