function init1() {
    ...
    document.f.a2.options[0] = new Option('0.45',0.50);
    document.f.a2.options[1] = new Option('0.50',0.50);
    document.f.a2.options[2] = new Option('0.55',0.50);
    ...
    document.f.a4.options[0] = new Option('0.45',0.50);
    document.f.a4.options[1] = new Option('0.50',0.50);
    document.f.a4.options[2] = new Option('0.55',0.50);
