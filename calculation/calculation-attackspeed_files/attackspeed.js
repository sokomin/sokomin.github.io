function init1() {
    ...
    document.f.a2.options[0] = new Option('0.50',0.50);
    document.f.a2.options[1] = new Option('0.60',0.60);
    document.f.a2.options[2] = new Option('0.75',0.75);
    document.f.a2.options[3] = new Option('0.80',0.80);
    document.f.a2.options[4] = new Option('0.90',0.90);
    document.f.a2.options[5] = new Option('1.00',1.00, 1, 1);
    document.f.a2.options[6] = new Option('1.10',1.10);
    document.f.a2.options[7] = new Option('1.20',1.20);
    document.f.a2.options[8] = new Option('1.30',1.30);
    document.f.a2.options[9] = new Option('1.40',1.40);
    document.f.a2.options[10] = new Option('1.50',1.50);
    document.f.a2.options[11] = new Option('1.60',1.60);
    document.f.a2.options[12] = new Option('1.70',1.70);
    document.f.a2.options[13] = new Option('1.80',1.80);
    document.f.a2.options[14] = new Option('2.00',2.00);
    document.f.a2.options[15] = new Option('2.50',2.50);
    document.f.a2.options[16] = new Option('3.00',3.00);

    document.f.a4.options[0] = new Option('0.50',0.50);
    document.f.a4.options[1] = new Option('0.60',0.60);
    document.f.a4.options[2] = new Option('0.75',0.75);
    document.f.a4.options[3] = new Option('0.80',0.80);
    document.f.a4.options[4] = new Option('0.90',0.90);
    document.f.a4.options[5] = new Option('1.00',1.00);
    document.f.a4.options[6] = new Option('1.10',1.10);
    document.f.a4.options[7] = new Option('1.20',1.20);
    document.f.a4.options[8] = new Option('1.30',1.30);
    document.f.a4.options[9] = new Option('1.40',1.40);
    document.f.a4.options[10] = new Option('1.50',1.50, 1, 1);
    document.f.a4.options[11] = new Option('1.60',1.60);
    document.f.a4.options[12] = new Option('1.70',1.70);
    document.f.a4.options[13] = new Option('1.80',1.80);
    document.f.a4.options[14] = new Option('2.00',2.00);
    document.f.a4.options[15] = new Option('2.50',2.50);
    document.f.a4.options[16] = new Option('3.00',3.00);
...
/*
     FILE ARCHIVED ON 16:02:25 Jan 25, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:16:58 Jan 18, 2019.
...
/*
playback timings (ms):
  LoadShardBlock: 60.619 (3)
  esindex: 0.013
  captures_list: 81.333
  CDXLines.iter: 14.272 (3)
  PetaboxLoader3.datanode: 90.456 (4)
  exclusion.robots: 0.329
  exclusion.robots.policy: 0.303
  RedisCDXSource: 1.123
  PetaboxLoader3.resolve: 16.957
  load_resource: 70.096
*/