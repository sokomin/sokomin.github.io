(function () {
    ...
    function renderCurrent() {
        ...
        nextBtn.textContent =
            (STATE.currentIdx + 1 >= total) ? '結果を見る' : '次へ';
    }
    ...
    function onRetry() { startQuiz(STATE.quizLevel); }
